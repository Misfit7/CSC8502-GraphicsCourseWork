...
SolarSystem::SolarSystem()
{
	...
	SetMesh(m);
	bump = SOIL_load_OGL_texture(TEXTUREDIR"Starfield/planetbump.png", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_MIPMAPS);

	//sun
	sun = new SceneNode();
	texture = SOIL_load_OGL_texture(TEXTUREDIR"Starfield/0.sun.jpg", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_MIPMAPS);
	...
	sun->SetBump(bump);
	sun->SetBoundingRadius(1000.0f);

	//mercury
	mercuryR = new SceneNode();
	mercury = new SceneNode();
	texture = SOIL_load_OGL_texture(TEXTUREDIR"Starfield/1.mercury.jpg", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_MIPMAPS);
	...
	goldR = new SceneNode();
	gold = new SceneNode();
	texture = SOIL_load_OGL_texture(TEXTUREDIR"Starfield/2.gold.jpg", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_MIPMAPS);
	...
	earth = new SceneNode();
	texture = SOIL_load_OGL_texture(TEXTUREDIR"Starfield/3.earth.jpg", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_MIPMAPS);
	...
	texture = SOIL_load_OGL_texture(TEXTUREDIR"Starfield/3.earth_clouds.jpg", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_MIPMAPS);
	earthCloud->SetColour(Vector4(1.0f, 1.0f, 1.0f, 0.5f));
	earthCloud->SetTransform(Matrix4::Translation(Vector3(0.0f, 0.0f, 0.0f)));
	earthCloud->SetModelScale(Vector3(63.5f, 63.5f, 63.5f));
	earthCloud->SetMesh(m);
	earthCloud->SetTexture(texture);
	earthCloud->SetBoundingRadius(63.5f);
	earth->AddChild(earthCloud);
	//moon
	moon = new SceneNode();
	texture = SOIL_load_OGL_texture(TEXTUREDIR"Starfield/3.5.moon.jpg", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_MIPMAPS);
	...
	fireR = new SceneNode();
	fire = new SceneNode();
	texture = SOIL_load_OGL_texture(TEXTUREDIR"Starfield/4.fire.jpg", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_MIPMAPS);
	...
	woodR = new SceneNode();
	wood = new SceneNode();
	texture = SOIL_load_OGL_texture(TEXTUREDIR"Starfield/5.wood.jpg", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_MIPMAPS);
	...
	soilR = new SceneNode();
	soil = new SceneNode();
	texture = SOIL_load_OGL_texture(TEXTUREDIR"Starfield/6.soil.jpg", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_MIPMAPS);
	...
	texture = SOIL_load_OGL_texture(TEXTUREDIR"Starfield/6.soilring.png", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_MIPMAPS);
	...
	texture = SOIL_load_OGL_texture(TEXTUREDIR"Starfield/7.tianwang.jpg", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_MIPMAPS);
	...
	texture = SOIL_load_OGL_texture(TEXTUREDIR"Starfield/8.haiwang.jpg", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_MIPMAPS);
...
void SolarSystem::Update(float dt)
{
	...
	soilR->SetTransform(soilR->GetTransform() * Matrix4::Rotation(3.04f * dt, Vector3(0, 1, 0))); //6
	...
	earth->SetTransform(earth->GetTransform() * Matrix4::Rotation(-60.0f * dt, Vector3(0, 1, 0))); //3
